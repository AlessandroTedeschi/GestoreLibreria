...
public class OrdinamentoValutazioneCrescente implements SortingStrategy
{
    ...
    public OrdinamentoValutazioneCrescente() { this(Locale.ITALY); }
    public OrdinamentoValutazioneCrescente(Locale locale) {
    ...
    public List<Libro> ordina(List<Libro> input) {
        ...
        out.sort(
                Comparator.comparingInt(Libro::getValutazione)            // <— int
